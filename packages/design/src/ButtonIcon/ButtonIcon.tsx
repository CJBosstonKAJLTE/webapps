...
const size = (props: ButtonIconProps) => {
  return sizeMap[props.size] || defaultSize;
};

const fromProps = (props: PropsWithTheme<ButtonIconProps>) => {
  const { theme } = props;
  return {
    '&:disabled': {
...
export const ButtonIcon = (props: React.PropsWithChildren<ButtonIconProps>) => {
